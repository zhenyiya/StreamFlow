...
func InitCmdEnv() *SysVars {
	...
	logPath := flag.String("log", constants.DefaultLogPath, "define the path to store zhenyiya log files")
	dsPath := flag.String("ds", constants.DefaultDataStorePath, "define the path to store zhenyiya registry data files")
